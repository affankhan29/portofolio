...
export const LetterGlitch: React.FC<LetterGlitchProps> = ({
  glitchColors = ["#C79A3C", "#8C3B2E", "#222220", "#6B6559"],
  className = "",
  glitchSpeed = 50,
  ...
  const outerVignetteStyle: React.CSSProperties = {
    ...
    pointerEvents: "none",
    background:
      "radial-gradient(circle, rgba(250,247,240,0) 50%, rgba(250,247,240,0.95) 100%)",
  };
  ...
  const centerVignetteStyle: React.CSSProperties = {
    ...
    pointerEvents: "none",
    background:
      "radial-gradient(circle, rgba(250,247,240,0.5) 0%, rgba(250,247,240,0) 60%)",
  };
